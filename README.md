...
###"Веб-ларек" - это интернет-магазин с товарами для веб-разработчиков. В нём можно посмотреть каталог товаров, добавить товары в корзину и сделать заказ. 

## Обзор проекта
![Preview image](assets/web-larek.png)
<details><summary>DEMO Web-larek</summary>

![Preview image](assets/web-larek.gif)  
</details>
...
- `form:reset` - очищение вводимых данных полей, для активации валидации, после закрытия модального окна крестиком/кликом по оверлею,
